...
import com.crowdmonitor.dto.request.RegisterRequest;
...
public class UserService {
    ...
    public UserResponse createUser(RegisterRequest request) {
        ...
        String roleName = request.getRole() == null ? "VIEWER" : request.getRole().toUpperCase();
        ...
        auditLogService.log("USER_ADDED", "USER", saved.getId(),
                "User '" + saved.getUsername() + "' created with role " + role.getName());
